...
urlpatterns = [
    ...
    path('purchase-quote/', views.purchase_quote, name='purchase_quote'),
    path('purchase-quote/export/', views.export_purchase_quote, name='export_purchase_quote'),
    ...
    path('api/scooter-details/', views.scooter_details_api, name='scooter_details_api'),
]
